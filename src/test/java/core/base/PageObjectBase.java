...
public abstract class PageObjectBase {
  ...
  public PageObjectBase() {
    this.config = Hooks.getConfigInfo();
    this.driver = Hooks.getDriver();
    this.data = Hooks.getTestData();
    setDecoratorBasedOnPlatform();
  }

  protected PageObjectBase navigate(String resource) {
    driver.get(Config.env + resource);
    return this;
  }
  ...
  public void selectDropdownItem(WebElement dropdown, String item) {
    dropdown.click();
    driver.findElement(By.cssSelector(String.format("li[data-value=\"%s\"]", item))).click();
  }
  ...
  public WebElement assertDisplayed(WebElement element) {
    assertDisplayed(element, 5);
    return element;
  }
